...
public class SamRecord {
    ...
    /** Nombres de los planes para identificar la agenda */
    @Column(name = "nombres_planes", columnDefinition = "TEXT")
    private String nombresPlanes;

    /** Servicios medicos a agendar con los doctores correspondientes */
    ...
    public SamRecord(Long compraId, Long clienteId, String planIds, String nombresPlanes,
